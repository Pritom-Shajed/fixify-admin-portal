...
class ViewTechnicianInfoPage extends StatefulWidget {
  ...
  @override
  State<ViewTechnicianInfoPage> createState() =>
      _ViewTechnicianInfoPageState();
}

class _ViewTechnicianInfoPageState
    extends State<ViewTechnicianInfoPage> {
  @override
          ...
          children: [
            TechnicianInfoHeader(
                onTapStatus: () => showCustomStatusDialog(context,
                    ...
                    onTap: () => Get.find<TechnicianController>().updateAccountStatus(uid: userData.uid!, status: userData.accountStatus == 'Inactive' ? 'Active' : 'Inactive')),
                status: userData.accountStatus!,
